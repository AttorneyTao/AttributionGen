...
def main():
    ...
    PROJECT_NAME = "Your Project Name"  # Name of your project
    COPYRIGHT_HOLDER_FULL = "Your Full Company Name L.L.C."  # Full legal name
    COPYRIGHT_HOLDER_SHORT = "YourCo"  # Short name for notices
